...
//
// gamma = c^2*psi and R = 1/(psi*T) are evaluated face-by-face from
// the thermo registry, capturing BPT's variable thermodynamic properties.
//
// Acoustic gradient relation for the refGrad [P&L Eq. 36]:
//
//     dT/dn = (gamma-1)/gamma * dp/dn / (rho*R)
